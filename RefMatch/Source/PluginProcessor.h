...
private:
    ...
    void pauseSpotifyAndRestore();
    SpotifyDesktopController spotifyController;
    TransportSwitch transportSwitch;
    juce::String transportError;
    double fadeDeadline = 0;
    bool spotifyStarted = false;
    ...
    ReferenceSafety referenceSafety;
    std::atomic<bool> referenceFailure { false };
    std::atomic<bool> rearmReference { false };
