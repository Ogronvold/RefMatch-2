...
private:
    ...
    void runSpotifyCommand(SystemMediaController::Command);
    void applySpotifyInfo(const SystemMediaInfo&);
    ...
    SystemMediaController& spotify;
    SystemMediaInfo spotifyInfo;
    ...
    juce::TextButton enableSpotifyButton { "ENABLE METERS" };
