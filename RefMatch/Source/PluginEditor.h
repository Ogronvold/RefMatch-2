...
private:
    ...
    juce::TextButton listenTab{"LISTEN"},eqTab{"MATCH EQ"},loopTab{"LOOP"};
    ...
    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> gainAttach,amountAttach,limitAttach;
